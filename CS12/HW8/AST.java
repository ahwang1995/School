...
class Product implements AST
{
  ...
  public Quantity eval(Map<String,Quantity> env)
  {
	  Quantity lquant = left.eval(env);
	  Quantity rquant = right.eval(env);
	  return lquant.mul(rquant);
  }  
...
class Power implements AST
{
  ...
  public Quantity eval(Map<String,Quantity> env)
  {
	  Quantity cquant = child.eval(env);
	  return cquant.pow(exponent);
  }
...
class Value implements AST
{
  ...
  public Quantity eval(Map<String,Quantity> env)
  {
	  Quantity newquant = new Quantity(quant);
	  return newquant;
  }  
...
class Define implements AST
{
  ...
  public Quantity eval(Map<String,Quantity> env)
  {
	  Quantity defquant = defn.eval(env);
	  env.put(unitName,defquant);
	  return env.get(unitName);
  }
